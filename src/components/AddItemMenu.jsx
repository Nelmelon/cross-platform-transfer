...
export default function AddItemMenu({ onTextClick }) {
  ...
  return (
    <div className="relative">
      <div className={`absolute bottom-16 left-1/2 transform -translate-x-1/2 flex flex-col items-center space-y-4 transition-all duration-300 ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'}`}>
        <button
        ...
        <span className="text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 px-2 py-1 rounded shadow-sm">Text</span>
        ...
        <span className="text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 px-2 py-1 rounded shadow-sm">Image (Soon)</span>
      </div>
